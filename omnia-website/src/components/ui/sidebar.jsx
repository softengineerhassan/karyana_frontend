  ...
  const Icon = () => {
    if (dir === "rtl") {
      ...
      return open ? (
        ...
        <ArrowLeftToLine className="size-4 text-primary" />
      );
    }
    // LTR (English etc.)
    return open ? (
